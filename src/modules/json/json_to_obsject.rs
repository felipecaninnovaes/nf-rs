pub mod object {
    ...
    impl Produto {
        ...
        // pub fn empty() {
        //     let value: Produto = Produto { n_item: 0, c_prod: "".to_string(), c_ean: "".to_string(), x_prod: "".to_string(), ncm: 0, cfop: 0, u_com: "".to_string(), q_com: 0.0, v_un_com: 0, v_prod: 0.0, c_eantrib: "".to_string(), u_trib: "".to_string(), q_trib: 0.0, v_un_trib: 0.0, ind_tot: 0, x_ped: "".to_string(), icms: (), ipi: Ipi::empty() };
        // }
