        ...
        let expected = Nfe {
            ...
            nfe_produtos: vec![
                Produto {
                    ...
                    produto_qcom: "1.0000".to_string(),
                    produto_vuncom: "69.9000000000".to_string(),
                    produto_vprod: "69.90".to_string(),
                    produto_ceantrib: "SEM GTIN".to_string(),
                    produto_utrib: "UN".to_string(),
                    produto_qtrib: "1.0000".to_string(),
                    produto_vuntrib: "69.9000000000".to_string(),
                    ...
                    imposto: Imposto {
                        imposto_icms: Icms {
                            ...
                            icms_cst: 0,
                            icms_modbc: 3,
                            icms_vbc: "69.90".to_string(),
                            icms_picms: "12.0000".to_string(),
                            icms_vicms: "8.39".to_string(),
                        },
                        imposto_ipi: Ipi {
                            ipi_cenq: 0,
                            ipi_cst: 0,
                        ...
                        imposto_pis: Pis {
                            pis_cst: 1,
                            pis_vbc: "57.32".to_string(),
                            pis_ppis: "1.6500".to_string(),
                            pis_vpis: "0.95".to_string(),
                        },
                        imposto_cofins: Cofins {
                            cofins_cst: 1,
                            cofins_vbc: "57.32".to_string(),
                            cofins_pcofins: "7.6000".to_string(),
                            cofins_vcofins: "4.36".to_string(),
                        },
                        imposto_icms_uf_dest: IcmsUfDest {
                            icms_uf_vbcufdest: "69.90".to_string(),
                            icms_uf_vbcfcpufdest: "69.90".to_string(),
                            icms_uf_pfcpufdest: "0.0000".to_string(),
                            icms_uf_picmsufdest: "18.0000".to_string(),
                            icms_uf_picmsinter: "12.00".to_string(),
                            icms_uf_picmsinterpart: "100.0000".to_string(),
                            icms_uf_vfcpufdest: "0.00".to_string(),
                            icms_uf_vicmsufdest: "4.19".to_string(),
                            icms_uf_vicmsufremet: "0.00".to_string(),
                        },
                    },
                },
                Produto {
                    ...
                    produto_ucom: "UN".to_string(),
                    produto_qcom: "1.0000".to_string(),
                    produto_vuncom: "29.9000000000".to_string(),
                    produto_vprod: "29.90".to_string(),
                    produto_ceantrib: "SEM GTIN".to_string(),
                    produto_utrib: "UN".to_string(),
                    produto_qtrib: "1.0000".to_string(),
                    produto_vuntrib: "29.9000000000".to_string(),
                    produto_indtot: "1".to_string(),
                    produto_xped: "999999999".to_string(),
                    imposto: Imposto {
                        imposto_icms: Icms {
                            ...
                            icms_cst: 0,
                            icms_modbc: 3,
                            icms_vbc: "29.90".to_string(),
                            icms_picms: "12.0000".to_string(),
                            icms_vicms: "3.59".to_string(),
                        },
                        imposto_ipi: Ipi {
                            ipi_cenq: 0,
                            ipi_cst: 0,
                        ...
                        imposto_pis: Pis {
                            pis_cst: 1,
                            pis_vbc: "24.52".to_string(),
                            pis_ppis: "1.6500".to_string(),
                            pis_vpis: "0.40".to_string(),
                        },
                        imposto_cofins: Cofins {
                            cofins_cst: 1,
                            cofins_vbc: "24.52".to_string(),
                            cofins_pcofins: "7.6000".to_string(),
                            cofins_vcofins: "1.86".to_string(),
                        },
                        imposto_icms_uf_dest: IcmsUfDest {
                            icms_uf_vbcufdest: "29.90".to_string(),
                            icms_uf_vbcfcpufdest: "29.90".to_string(),
                            icms_uf_pfcpufdest: "0.0000".to_string(),
                            icms_uf_picmsufdest: "18.0000".to_string(),
                            icms_uf_picmsinter: "12.00".to_string(),
                            icms_uf_picmsinterpart: "100.0000".to_string(),
                            icms_uf_vfcpufdest: "0.00".to_string(),
                            icms_uf_vicmsufdest: "1.79".to_string(),
                            icms_uf_vicmsufremet: "0.00".to_string(),
                        },
                    },
                },
                Produto {
                    ...
                    produto_ucom: "UN".to_string(),
                    produto_qcom: "1.0000".to_string(),
                    produto_vuncom: "49.9000000000".to_string(),
                    produto_vprod: "49.90".to_string(),
                    produto_ceantrib: "SEM GTIN".to_string(),
                    produto_utrib: "UN".to_string(),
                    produto_qtrib: "1.0000".to_string(),
                    produto_vuntrib: "49.9000000000".to_string(),
                    produto_indtot: "1".to_string(),
                    produto_xped: "999999999".to_string(),
                    imposto: Imposto {
                        imposto_icms: Icms {
                            ...
                            icms_cst: 0,
                            icms_modbc: 3,
                            icms_vbc: "49.90".to_string(),
                            icms_picms: "12.0000".to_string(),
                            icms_vicms: "5.99".to_string(),
                        },
                        imposto_ipi: Ipi {
                            ipi_cenq: 0,
                            ipi_cst: 0,
                        ...
                        imposto_pis: Pis {
                            pis_cst: 1,
                            pis_vbc: "40.92".to_string(),
                            pis_ppis: "1.6500".to_string(),
                            pis_vpis: "0.68".to_string(),
                        },
                        imposto_cofins: Cofins {
                            cofins_cst: 1,
                            cofins_vbc: "40.92".to_string(),
                            cofins_pcofins: "7.6000".to_string(),
                            cofins_vcofins: "3.11".to_string(),
                        },
                        imposto_icms_uf_dest: IcmsUfDest {
                            icms_uf_vbcufdest: "49.90".to_string(),
                            icms_uf_vbcfcpufdest: "49.90".to_string(),
                            icms_uf_pfcpufdest: "0.0000".to_string(),
                            icms_uf_picmsufdest: "18.0000".to_string(),
                            icms_uf_picmsinter: "12.00".to_string(),
                            icms_uf_picmsinterpart: "100.0000".to_string(),
                            icms_uf_vfcpufdest: "0.00".to_string(),
                            icms_uf_vicmsufdest: 2.99.to_string(),
                            icms_uf_vicmsufremet: "0.00".to_string(),
                        },
                    },
                },
    ...
    fn new_nfe_single_products() {
        ...
        let expected = Nfe {
            ...
            nfe_produtos: vec![Produto {
                ...
                produto_ucom: "UN".to_string(),
                produto_qcom: "10.0000".to_string(),
                produto_vuncom: "61.43000000".to_string(),
                produto_vprod: "614.30".to_string(),
                produto_ceantrib: "7899625704614".to_string(),
                produto_utrib: "UN".to_string(),
                produto_qtrib: "10.0000".to_string(),
                produto_vuntrib: "61.43000000".to_string(),
                produto_indtot: "1".to_string(),
                ...
                imposto: Imposto {
                    imposto_icms: Icms {
                        ...
                        icms_cst: 0,
                        icms_modbc: 3,
                        icms_vbc: "583.59".to_string(),
                        icms_picms: "4.0000".to_string(),
                        icms_vicms: "23.34".to_string(),
                    },
                    imposto_ipi: Ipi {
                        ipi_cenq: 999,
                        ipi_cst: 50,
                        ipi_vbc: "614.30".to_string(),
                        ipi_pipi: 0,
                        ipi_vipi: 0,
                    },
                    imposto_pis: Pis {
                        pis_cst: 1,
                        pis_vbc: "560.25".to_string(),
                        pis_ppis: "1.6500".to_string(),
                        pis_vpis: "9.24".to_string(),
                    },
                    imposto_cofins: Cofins {
                        cofins_cst: 1,
                        cofins_vbc: "560.25".to_string(),
                        cofins_pcofins: "7.6000".to_string(),
                        cofins_vcofins: "42.58".to_string(),
                    },
                    imposto_icms_uf_dest: IcmsUfDest {
